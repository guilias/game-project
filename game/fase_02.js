    ...
    passarFase(){
            ...
            player.y + player.altura > this.y)
        {
            if (player.pontuacao == maxPontos){
                window.location.href = "./interludio/scriptfase2.html" //avançar para próxima fase
            }
            else{
...
let chaoMadeira = new Objeto("rgb(106, 90, 36)", null, 0, canvas.height - 20, canvas.width - 10, 10, false);

let paredeInvisivel = new Objeto("rgb(0, 0, 0, 0)", null, 0, 450, 10, 150, false)
let paredeInvisivel2 = new Objeto("rgb(0, 0, 0, 0)", null, canvas.width, 0, 10, 600, false)
...
function loopAnimacao(){
    ...
    paredeInvisivel2.colisao()

    avancarFase.desenha()
    avancarFase.passarFase()

    plataforma01.desenha()
    plataforma01.colisao()

    plataforma02.desenha()
    plataforma02.colisao()

    plataforma03.desenha()
    plataforma03.colisao()

    plataforma04.desenha()
    plataforma04.colisao()
    ...
    espinhos03.colisao()
    espinhos03.carregarVisual("img/espinhos.png")

    espinhos04.colisao()
    espinhos04.carregarVisual("img/espinhos.png")

    espinhos05.colisao()
    espinhos05.carregarVisual("img/espinhos.png")
